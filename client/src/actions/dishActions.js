...
export const getAllDishes=()=>async dispatch=>{
    ...
    try {
        const response = await axios.get('/dishes/getalldishes')
...
export const getDishById=(dishid)=>async dispatch=>{
    ...
    try {
        const response = await axios.post('/dishes/getdishbyid' , {dishid})
        console.log(response);
...
export const addDish=(dish)=>async dispatch=>{
    ...
    try {
        const response= await axios.post('/dishes/adddish' , {dish})
        console.log(response);
...
export const editDish=(editeddish)=>async dispatch=>{
    ...
    try {
        const response= await axios.post('/dishes/editdish' , {editeddish})
        console.log(response);
...
try {
    const response =await axios.post('/dishes/deletedish' , {dishid})
